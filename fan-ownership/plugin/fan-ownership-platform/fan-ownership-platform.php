...
require_once PRX3_DIR . 'includes/class-prx3-shopify.php';
...
require_once PRX3_DIR . 'includes/class-prx3-helpbot.php';
...
require_once PRX3_DIR . 'includes/api/class-prx3-data-api.php';

// Admin.
require_once PRX3_DIR . 'includes/class-prx3-admin-columns.php';
...
require_once PRX3_DIR . 'includes/class-prx3-pages.php';
...
function prx3_assets() {
	...
	wp_register_script( 'prx3-mentions', PRX3_URL . 'assets/js/prx3-mentions.js', array( 'prx3' ), PRX3_VERSION, true );
	wp_register_style( 'prx3-leaflet', 'https://unpkg.com/leaflet@1.9.4/dist/leaflet.css', array(), '1.9.4' );
	wp_register_script( 'prx3-leaflet', 'https://unpkg.com/leaflet@1.9.4/dist/leaflet.js', array(), '1.9.4', true );
	wp_localize_script(
		'prx3',
		'prx3Config',
		array(
