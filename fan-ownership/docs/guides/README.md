...
| `forum-guide.md` | Club staff, members | The native forum and social layer: boards, automated threads, chat archiving, thread-to-ballot conversion, activity feed, follows, private messages, notifications, @mentions, house rules |
