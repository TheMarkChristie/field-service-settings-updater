...
|-------|-------|---------|---------|---------|
| 1 | Own | `phase-1-own.md` | FO-101 to FO-131 | A supporter anywhere in the world becomes a paying owner and feels it: shares, certificate, badge, onboarding, first exclusive content, a signed Shareholders' Agreement, and a CRM that always knows the members |
