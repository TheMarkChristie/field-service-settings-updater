...
| FO-235 Owner profile | Done | 3.11.0.0 | `PRX3_Social::activity_score`/`record_match_watch`/`shortcode_profile` — activity ring (voting/community/watching), bio + socials + share-visibility choice, public card with follow, directory links, profile page in the installer; WP Users screens link to the live profile (3.12.1.0) | |
