...
| P129 | FanPress branding | Build **3.15.1.2**: the admin is unified under the **FanPress** brand — "Fan App Settings" becomes **FanPress Settings** and "Fan Club Technical Setup" becomes **FanPress Technical Setup**, joining the existing FanPress Chat menu. Menu labels, page headings, notices, and all guides updated; page slugs are unchanged so bookmarks and deep links keep working |
